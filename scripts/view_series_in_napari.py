...
@magicgui(
    ...
    open_1c_stabilize={"widget_type": "CheckBox", "label": "1c_stabilize"},
...
#                folder: pathlib.Path = '/Users/bwoodhams/Documents/plast_cell/1_data/',
    ...
    if lazy_loading:
        for open_this, name in zip([open_1_data, open_1c_stabilize, open_2_segmentation, open_3b_tracking_images, open_3c_tracking_images_filtered, open_5_tracking_images_outlines], 
                                ['1_data', '1c_stabilize', '2_segmentation', '3b_tracking_images', '3c_tracking_images_filtered', '5_tracking_images_outlines']):
            if open_this:
